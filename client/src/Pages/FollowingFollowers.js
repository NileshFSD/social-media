...
const FollowingFollowers = () => {
  ...
  useEffect(() => {
    async function findFollowingFollowers() {
      const req = await fetch(
        "https://rich-gold-pangolin-kilt.cyclic.app/api/hey/user/get-following-followers-list",
        {
          method: "GET",
          headers: {
  ...
  const followUnfollow = async (id) => {
    const response = await fetch(
      `https://rich-gold-pangolin-kilt.cyclic.app/api/hey/user/follow-unfollow/${id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
